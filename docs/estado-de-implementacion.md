...
| Proceso del reloj | `jafne reloj` espera al primer despertar y lo dispara; `jafne reloj --ver` muestra la cola sin tocar nada. Un despertar vencido no se repone, y el candado del almacén impide dos relojes. | ADR-0035 |
